...
class ImageUpload(models.Model):
    ...
    Edwardsiella = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    Vibrio = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    Streptococcus = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    Tenacibaculumn = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    Enteromyxum = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    Miamiensis = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
    VHSV = models.DecimalField(max_digits=2, decimal_places=2, default=Decimal('0.00'))
